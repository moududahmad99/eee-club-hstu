        ...
        <div className="row new-main mt-5">
            <div className="newsNevent-main col-lg-12 my-5">
              ...
              <div className="newsNevent-cards">
                <div className="news-card">
                  <img className="card-img-top" src="images/eventsNew.jpg" alt="Card image" />
                ...
                <div className="news-card">
                  <img className="card-img-top" src="images/exhibition.jpg" alt="Card image" />
                  <div className="news-body">
              ...
              <div className="notice-button1 mt-5">
                ...
                <Button variant="contained" className='mb-5'>View More</Button>
              </div>
            </div>
          </div>
          ...
          <div class="row justify-content-evenly mt-4 events">
            <div class="events-card col-lg-5 my-5">
              <img class="card-img-top" src="images/eventsNew.jpg" alt="Card image" />
