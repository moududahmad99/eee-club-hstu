  ...
  return (
    <>
      ...
      <div class="row width-100 banner mt-3">
        <h1>EEE CLUB OF HSTU</h1>
        <h4>A place for learning, discovery, innovation, expression and discourse</h4>
      </div>
            ...
            <div className="newsNevent-main col-lg-8 col-md-6 col-12 my-5">
              ...
              <div className="newsNevent-cards">
                <div className="news-card">
                  <img className="card-img-top" src="images/gallery-4.jpg" alt="Card image" />
                ...
                <div className="news-card">
                  <img className="card-img-top" src="images/gallery-2.jpg" alt="Card image" />
                  <div className="news-body">
        ...
        <div className="row">
          <div className="col-lg-6 col-12">
            <div className="contact-map">
              <div id="map-container-google-3" className="z-depth-1-half map-container-3 m-5">
                <Iframe
